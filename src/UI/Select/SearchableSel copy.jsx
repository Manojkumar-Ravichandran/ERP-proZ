...
const SearchableSelect = ({
  ...
  return (
    <div className={`${styles.inputContainer} w-full ${marginClass ?? 'mb-3'} `}>
      <label htmlFor={id} className={`mb-0 ${styles.label}`} style={{ paddingBottom: '.25rem' }}>
        {label}
