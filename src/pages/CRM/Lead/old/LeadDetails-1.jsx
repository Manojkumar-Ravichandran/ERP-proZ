...
const LeadDetail = () => {
  ...
  const handleSubmit = (data) => {
    const payload = {
      ...
      lead_id: lead?.id,
      date: data?.schedule_time,
      next_followup: data["next-schedule_time"],
