...
import { getLeadCallListEffect, getLeadMailListEffect } from '../../../../redux/CRM/lead/LeadEffects';
...
export default function LeadCall({ uuid }) {
  ...
  useEffect(() => {
    if (uuid) {
      (async () => {
        const payload = { uuid };
        const { data } = await getLeadCallListEffect({ ...payload });
