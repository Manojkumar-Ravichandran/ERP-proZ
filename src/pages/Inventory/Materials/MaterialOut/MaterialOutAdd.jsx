...
const MaterialOutAdd = ({ onSuccess }) => {
    ...
    useEffect(() => {
        // Set today's date and time as the default value
    ...
    return (
        <>
            ...
            <IconButton label="Add Material Out" icon={icons.plusIcon} onClick={() => setIsMasterCreateModal(true)} />
            ...
            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <IconButton label="Add Material Out" icon={icons.saveIcon} type="submit" className="my-3" loading={loading} />
                </form>
            </Modal>
        </>
    );
