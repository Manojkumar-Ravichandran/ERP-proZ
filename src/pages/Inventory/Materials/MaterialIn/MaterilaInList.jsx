...
const MaterialInList = () => {
    ...
    const handleAction = (action, e, master, callback) => {
        ...
        const { uuid, id, date, material_type, received_sent_by, logistics_type, vehicle_no, invoice_ref_no, attachment, item_id, quantity, unit, unit_name ,material_name} = e?.data || {};
    ...
    const fetchData = () => {
        dispatch(fetchMaterialInOut({ page: paginationCurrentPage, per_page: paginationPageSize, type: "in" }));
    };
        ...
        <>
            ...
            <div className="bg-white py-3 rounded-lg darkCardBg">
                <div className="bg-white rounded-lg pe-3 flex items-center justify-between">
                    ...
                    <div className="flex items-center">
                        <div className="me-3">
                            <MaterialInAdd onSuccess={handleCreateSuccess} />
                        </div>
                        <div>
