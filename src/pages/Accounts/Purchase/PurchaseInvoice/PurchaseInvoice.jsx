...
export default function PurchaseInvoice() {
  ...
  const fetchLeadList = async () => {
    setLoading(true);
    try {
      const response = await listPurchaseInvoiceEffect({
          ...
          >
            ...
            {params?.data?.status === 1 &&
              ...
              <span
                ...
                onClick={() => {
                  navigate("/user/accounts/purchase/create-purchase-invoice", { state: { ...params.data } });
                }}
              >
        ...
        <div className=" rounded-lg pe-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <IconButton
              ...
              icon={icons.plusIcon}
              onClick={() => {
                navigate("/user/accounts/purchase/create-purchase-invoice");
              }}
            />
          </div>
        </div>
