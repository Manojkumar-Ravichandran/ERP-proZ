...
export default function CreateSalesQuotation() {
    ...
    const breadcrumbItems = [
        ...
        { id: 2, label: "Sales", link: "/user/accounts/sale/sale-quotation" },
        { id: 3, label: "Create Sale Quotation" }
    ];
    ...
    const addMasterHandler = async (data) => {
        ...
        if (location.state) {
            ...
            apiEndpoint = updateSaleQuotationEffect(payload); // Ensure this function is available
        } else {
            const payload = {
            ...
            apiEndpoint = createSaleQuotationEffect(payload);
        }
