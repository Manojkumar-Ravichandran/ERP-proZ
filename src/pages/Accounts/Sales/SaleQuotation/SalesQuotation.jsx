...
import { getSaleQuotationListEffect, MailShareEffect, PdfCustomerEffect, rejectSaleQuotationEffect, SQToInvoiceEffect, SQToOrderEffect, WhatsAppShareEffect } from "../../../../redux/Account/Sales/SaleQuotation/SaleQuotationEffects";
...
export default function Accounts() {
  ...
  const fetchLeadList = async () => {
    setLoading(true);
    try {
      const response = await getSaleQuotationListEffect({
        ...
        <div className=" rounded-lg pe-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <IconButton
              ...
              icon={icons.plusIcon}
              onClick={() => {
                navigate("/user/accounts/sale/create-sale-quotation");
              }}
            />
          </div>
        </div>
