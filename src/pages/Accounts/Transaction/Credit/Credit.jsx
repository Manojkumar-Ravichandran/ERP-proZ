...
import TotalPaymentReceived from "./TotalPaymentReceived";
import NumberOfTransaction from "./NumberOfTransaction";
import DateRangePickerComponent from "../../../../UI/AgGridTable/DateRangePickerComponent/DateRangePickerComponent";
import { formatDateToYYYYMMDD } from "../../../../utils/Date";
import { getCreditListEffect } from "../../../../redux/Account/Transactions/Transaction";
...
export default function Credit() {
  ...
  const fetchLeadList = async () => {
    setLoading(true);
    try {
      const response = await getCreditListEffect({
  ...
  const columnDefs = [
    ...
    { headerName: "Type", field: "purpose_name", unSortIcon: true },
    {
      ...
      unSortIcon: true,
      cellRenderer: (params) => {
        const name = params?.data?.sender_name || "";
  ...
  return (
    <>
      ...
      <div className="flex col-span-3 flex-wrap gap-6 mb-6">
