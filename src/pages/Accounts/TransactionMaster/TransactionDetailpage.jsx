...
import CreateTransactionMaster from './CreateTransactionMaster';

const TransactionDetail = ({ activeCard }) => {
    const {
        register,
        control, reset,
        setValue,
    ...
    const fetchLeadList = async () => {
        ...
        try {
            const response = await getTransactionMatsterListEffect({ type: activeCard, search: searchText });
                        ...
                        <div className="me-3">
                            <IconButton
                                ...
                                onClick={() => {
                                    ...
                                    setSelectedData({ type: activeCard }); // Clear selected data
                                }
                                }
                            />
                        </div>
